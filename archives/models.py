...
class Repository(models.Model):
    name = models.CharField(max_length=400, help_text=u"Enter the current name of the repository")
...
class Container(models.Model):
    ...
    collection = models.ForeignKey(Collection, help_text=u"Select the collection to which this container belongs; click the green plus sign (+) to add a new repository to the archive", on_delete=models.CASCADE)
...
class ContainerStatements(models.Model):
    container_id = models.ForeignKey(Container, related_name='container_statements', on_delete=models.CASCADE)
...
class DocumentStatements(models.Model):
    document_id = models.ForeignKey(Document, related_name='document_statements', on_delete=models.CASCADE)
    statement_type = models.CharField(max_length=1, choices=STATEMENT_TYPES, help_text=u"Indicate the kind of statement being made about this container")
