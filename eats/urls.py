...
urlpatterns = [
    ...
    url(r'^(?P<entity_id>\d+)/eac/(?P<authority_record_id>\d+)/', main.display_entity_eac),
    ...
    url(r'^entities/(?P<entity_type_id>\d+)/$', main.entities_by_type, name='entities_by_type'),
    url(r'^get_names/$', main.get_names),
    url(r'^get_primary_authority_records/$', main.get_primary_authority_records),

    url(r'^edit/import/$', edit.import_eatsml), # Human usable import from EATSML
    url(r'^edit/import/(?P<import_id>\d+)/$', edit.display_import),
    url(r'^edit/import/(?P<import_id>\d+)/raw/$', edit.display_import_raw),
    url(r'^edit/import/(?P<import_id>\d+)/processed/$', edit.display_import_processed),
    ...
    url(r'^edit/delete/(?P<model_name>[^/]+)/(?P<object_id>\d+)/$', edit.delete_object),
    url(r'^edit/(?P<model_name>[^/]+)/(?P<object_id>\d+)/$', edit.edit_model_object, name='edit_model_object'),
